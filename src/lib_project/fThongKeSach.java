 ...
 * @author Phuong Thang
 */
public class fThongKeSach extends javax.swing.JFrame {
    ...
    public final void getData()
    {
        ...
        listsach = new DAO_ThongKe().ThongKeLoaiSach();
        int i = 1;
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/package-zip-or-something-like-this-icon.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fThongKeSach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fThongKeSach().setVisible(true);
            }
        });
    }
